...
(global-set-key (kbd "C-c f R") 'mrm/rotate-windows-anticlockwise)
(global-set-key (kbd "C-c f b") 'balance-windows)
(global-set-key (kbd "C-c f r") 'mrm/rotate-windows-clockwise)
(global-set-key (kbd "C-c f s") 'mrm/toggle-window-split)
...
(global-set-key (kbd "C-c i r") 'mrm/reload-emacs)
...
(global-set-key (kbd "C-c p F") 'mrm/project-find-file)
