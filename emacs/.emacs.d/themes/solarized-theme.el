...
(custom-theme-set-faces
 ...
 '(helm-selection ((t (:inherit (solarized-magenta-bg solarized-base3-fg)))))
 '(helm-source-header ((t (:inherit (solarized-yellow-fg solarized-base2-bg) :height 1.3))))
 ...
 '(mode-line-inactive ((((class color) (min-colors 88)) (:inherit (solarized-base3-bg mode-line))) (t (:inherit (solarized-base1-fg mode-line)))))
